...
public class Patterns {
    ...
    private static final Set<String> keywords = new HashSet<>(Arrays.asList(VALUES_KEY));
    private static final Set<Character> punctuation = new HashSet<>(Arrays.asList(VALUES_PUN));
    private static final Set<String> literals = new HashSet<>(Arrays.asList(VALUES_LIT));
